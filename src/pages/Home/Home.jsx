    ...
    <div className="relative min-h-screen h-fit pb-4 ">
      <div className="">
        <div className=" banner relative mx-auto w-[100vw] h-[100vw] sm:w-[70vw] sm:h-[70vw] max-w-[1000px] max-h-[1000px] flex flex-col justify-center gap-2 ">
          ...
          <button className="duration-300 cursor-pointer hover:scale-110 inline-block bg-zinc-100 dark:bg-zinc-800 w-fit rounded-full mx-auto text-main-color px-4 md:py-2 font-medium md:text-lg  lg:text-xl ">
            {props.t("Banner.Button")}
          </button>
